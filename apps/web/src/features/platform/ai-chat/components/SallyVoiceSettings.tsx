...
/** All voices are Sally — different tones. */
const VOICE_TONES = [
...
export function SallyVoiceSettings() {
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="right" pinnable resizable className="w-full sm:max-w-sm">
          ...
          <div className="mt-6 space-y-8">
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Sally responds as soon as you finish speaking</p>
                  </div>
                </label>
              </RadioGroup>
            </div>
            ...
            {/* Voice Tone */}
            <div className="space-y-3">
              <Label className="text-sm font-medium">Sally&apos;s Tone</Label>
