...
interface SallyChatProps {
   ...
   * Sally strip which has no outer chrome.
   */
  embedded?: boolean;
}

export function SallyChat({ embedded = false }: SallyChatProps) {
  const {
    messages,
    orbState,
    userMode,
    ...
    <div className="flex flex-col flex-1 min-h-0">
        ...
        <div className="relative">
          ...
          <div className="relative p-4 space-y-4">
            ...
            {!isViewingHistory && hasOnlyGreeting && (
              ...
              >
                <div className="mb-4">
                  <SallyOrb state="idle" size="lg" alwaysAmbient />
                </div>
      ...
      {!isViewingHistory && (
        <div className="shrink-0">
          <SallyActionBar onSelect={(text) => sendMessage(text, 'text')} />
