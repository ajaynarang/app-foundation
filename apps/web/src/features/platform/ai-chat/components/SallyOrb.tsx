...
export function SallyOrb({
  ...
  return (
    <button
      ...
      aria-label={hasUnread ? 'Ask Sally — new results available' : 'Ask Sally'}
    >
      ...
      >
        {/* S icon — canonical SALLY logo mark */}
      ...
      {/* Keyboard-shortcut chip — Dock-style label that fades in above the
          ...
          the bare key (`S`) because that matches the binding in SallyStrip.
