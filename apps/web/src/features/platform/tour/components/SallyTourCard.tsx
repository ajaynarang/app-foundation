...
export function SallyTourCard({ step, currentStep, totalSteps, nextStep, prevStep, arrow }: CardComponentProps) {
    ...
    >
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-2">
        <div className="flex items-center gap-2.5">
          <SallyOrb state={isNavigating ? 'thinking' : 'idle'} size="sm" />
          <span className="text-sm font-semibold text-foreground">Sally</span>
        </div>
