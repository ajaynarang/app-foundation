...
interface AssistantInternalsSectionProps {
 ...
 */
export function AssistantInternalsSection({ kind, rateLimitPerMinute }: AssistantInternalsSectionProps) {
  ...
  return (
    <div className="mt-6 rounded-md border border-dashed border-border bg-muted/30 p-4">
      <h4 className="text-sm font-semibold text-foreground">Assistant internals</h4>
