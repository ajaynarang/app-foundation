...
export default function OAuthClientsSettingsPage() {
  ...
  return (
    <FeatureGuard featureKey="oauth_clients">
      <div className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <span>
              AI assistants like Claude and ChatGPT register automatically when you connect them. Use this page to
              control redirect URIs, scopes, and rotation yourself.
            </span>
            <a
