...
describe('DeskMemoryController.list', () => {
  ...
  it('leaves filters undefined when the query omits them', async () => {
    await controller.list({ dbId: 1 }, 'assistant-dispatch');
    ...
    expect(call.agentKey).toBe('assistant-dispatch');
