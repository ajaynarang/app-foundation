...
const CACHE_NULL_SENTINEL = '__SALLY_NULL__';
 ...
 */
@Injectable()
export class SallyCacheService implements OnModuleInit {
  private readonly logger = new Logger(SallyCacheService.name);
