...
export function JobDetailSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-lg p-6 overflow-y-auto" pinnable resizable>
        <SheetHeader>
          ...
          {job.errorMessage && (
            <>
              ...
              <div className="space-y-2">
                ...
                <pre className="text-xs bg-red-50 dark:bg-red-950/30 text-red-800 dark:text-red-300 p-3 rounded-md overflow-auto max-h-40 font-mono whitespace-pre-wrap">
                  {job.errorMessage}
                </pre>
