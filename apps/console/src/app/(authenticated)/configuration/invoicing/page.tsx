...
import { useInvoiceSettings, useUpdateInvoiceSettings } from '@/features/invoicing/use-invoice-settings';
import { FactoringCompaniesSection } from '@/features/invoicing/components/factoring-companies-section';
import type { InvoiceSettings } from '@/features/invoicing/api';
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Configure your company branding, payment terms, and invoice defaults.
          </p>
        </div>
        <SettingsSkeleton />
      </div>
