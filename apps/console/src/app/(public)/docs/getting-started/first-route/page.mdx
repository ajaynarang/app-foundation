...
If the driver deviates from the plan or an HOS threshold approaches, SALLY generates alerts automatically. You can subscribe to real-time alerts using [Server-Sent Events](/docs/api-guides/alerts-monitoring/real-time-events).
...
const BASE_URL = "https://sally-api-staging.appshore.in/api/v1";
