...
Go to **[API Keys](/docs/keys)** and sign in with your SALLY account. Click **Generate Key**, give it a name, and copy the key. It starts with `sk_staging_`.
...
Don't have an account? [Sign up at sally.appshore.in](https://sally.appshore.in).
