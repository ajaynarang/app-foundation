...
const res = await fetch("https://api-staging.appshore.in/api/v1/drivers", {
...
- [Plan a Route](/docs/getting-started/plan-a-route) — See Platform's route optimization in action
