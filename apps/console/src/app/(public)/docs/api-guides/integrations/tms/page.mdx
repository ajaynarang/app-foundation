...
```bash
curl -X POST https://sally-api-staging.appshore.in/api/v1/integrations/int_m1c2l3d4/test \
  -H "X-API-Key: $SALLY_API_KEY"
```
...
```bash
curl -X POST https://sally-api-staging.appshore.in/api/v1/integrations/int_p4q5r6s7/test \
  -H "X-API-Key: $SALLY_API_KEY"
```
