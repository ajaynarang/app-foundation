...
Platform automatically inserts rest stops into routes when the HOS simulation detects that a driver cannot legally complete a segment. This page explains how rest decisions are made and how they appear in route plans.
...
Platform enforces all of these rules. Routes with zero violations are guaranteed.
