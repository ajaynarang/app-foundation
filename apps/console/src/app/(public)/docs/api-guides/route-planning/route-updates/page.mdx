...
Platform continuously monitors active routes and updates them when conditions change. This page explains the trigger system, the re-plan vs ETA-update decision, and how route versioning works.
...
Platform monitors 20 alert types across 6 categories. Each trigger is evaluated to determine whether a re-plan or ETA update is needed.
