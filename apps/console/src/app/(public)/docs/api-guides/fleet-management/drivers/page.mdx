...
```bash
curl -X POST https://sally-api-staging.appshore.in/api/v1/drivers \
...
```bash
curl "https://sally-api-staging.appshore.in/api/v1/drivers?status=ACTIVE&page=1&pageSize=25" \
  -H "X-API-Key: $SALLY_API_KEY"
```
...
const response = await fetch(
  `https://sally-api-staging.appshore.in/api/v1/drivers?${params}`,
  {
...
```bash
curl https://sally-api-staging.appshore.in/api/v1/drivers/drv_a1b2c3d4 \
  -H "X-API-Key: $SALLY_API_KEY"
```
...
```javascript
const response = await fetch(
  "https://sally-api-staging.appshore.in/api/v1/drivers/drv_a1b2c3d4",
  {
    headers: { "X-API-Key": process.env.SALLY_API_KEY },
  }
);
...
```bash
curl -X PUT https://sally-api-staging.appshore.in/api/v1/drivers/drv_a1b2c3d4 \
  -H "X-API-Key: $SALLY_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST https://sally-api-staging.appshore.in/api/v1/drivers/drv_a1b2c3d4/deactivate \
  -H "X-API-Key: $SALLY_API_KEY"
```
...
```bash
curl -X DELETE https://sally-api-staging.appshore.in/api/v1/drivers/drv_a1b2c3d4 \
  -H "X-API-Key: $SALLY_API_KEY"
```
...
```bash
curl -X POST https://sally-api-staging.appshore.in/api/v1/drivers/drv_a1b2c3d4/reactivate \
  -H "X-API-Key: $SALLY_API_KEY"
```
...
```bash
curl https://sally-api-staging.appshore.in/api/v1/drivers/drv_a1b2c3d4/hos \
  -H "X-API-Key: $SALLY_API_KEY"
```
...
```javascript
const response = await fetch(
  "https://sally-api-staging.appshore.in/api/v1/drivers/drv_a1b2c3d4/hos",
  {
    headers: { "X-API-Key": process.env.SALLY_API_KEY },
  }
);
