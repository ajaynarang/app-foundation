...
Platform generates alerts across six categories. Each category contains specific alert types with defined priority levels and recommended dispatcher actions. This page serves as a complete reference for every alert your fleet may encounter.
...
- [Real-time Events](/docs/api-guides/alerts-monitoring/real-time-events) -- Subscribe to alerts via SSE or WebSocket
- [Alert Management](/docs/api-guides/alerts-monitoring/alert-management) -- Acknowledge, resolve, and analyze alerts
- [Alerts Overview](/docs/api-guides/alerts-monitoring) -- Alert system architecture and lifecycle
