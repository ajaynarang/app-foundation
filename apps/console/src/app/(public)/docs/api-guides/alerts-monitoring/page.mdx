...
Once you [activate a route](/docs/getting-started/first-route#step-7-activate-the-route), SALLY's monitoring service begins tracking it across 20 alert types in 6 categories. The monitoring loop runs continuously:
...
const response = await fetch(
  "https://sally-api-staging.appshore.in/api/v1/alerts?status=ACTIVE",
  {
...
curl "https://sally-api-staging.appshore.in/api/v1/alerts/stats" \
  -H "X-API-Key: $SALLY_API_KEY"
```
